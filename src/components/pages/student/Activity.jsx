									...
									<div style={{ padding: '1em', lineHeight: '1.5' }}>
										{
											activity.description
												...
												:
												<p className='card__description m-0 text-blue-600' style={{ lineHeight: '1.5' }}>{`Esta actividad no cuenta con una descripción. Puede mandar un correo a ${activity.user?.email} y consultar más detalles sobre la misma.`}</p>
										}
									</div>
								</ScrollPanel>
							</div>
	...
	return (
		<div className='main'>
			<div className="grid">
				...
				<ActivityCard title={'Cursos'} count={course.length} icon={'pi-book text-blue-500'} />
		
				<ActivityCard title={'Eventos'} count={events.length} icon={'pi-bookmark text-orange-500'} />
		
				<ActivityCard title={'Total horas  Art.140'} count={0} icon={'pi-clock text-cyan-500'} />
			
				<ActivityCard title={'Comentarios'} count={0} icon={'pi-comment text-purple-500'} />
						...
						<div className="flex justify-content-center">
							<div className="card flex justify-content-center" style={{ maxWidth: '100%' }}>
								<Carousel value={events} numVisible={1} numScroll={1} orientation="vertical" verticalViewPortHeight="400px"
									itemTemplate={activityTemplate} header={headerEvent} circular autoplayInterval={4000} style={{ width: '100%', marginTop: '1em' }} />
							</div>
						</div>
					</div>
				</div>
						...
						<div className="flex justify-content-center">
							<div className="card flex justify-content-center" style={{ maxWidth: '100%' }}>
								<Carousel value={course} numVisible={1} numScroll={1} orientation="vertical" verticalViewPortHeight="400px"
									itemTemplate={activityTemplate} header={headerCourse} circular autoplayInterval={3000} style={{ width: '100%', marginTop: '1em' }} />
							</div>
						</div>
					</div>
				</div>
